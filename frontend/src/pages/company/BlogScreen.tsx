...
export function BlogScreen({ onNavigate }: { onNavigate: (s: Screen | string) => void }) {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 py-24">
        <h1 className="text-4xl font-black text-gray-900 mb-8" style={{ fontFamily: "'Clash Display', sans-serif" }}>Blog</h1>
